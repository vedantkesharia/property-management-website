...
// FloorPlanModal Component
const FloorPlanModal = ({ isOpen, onClose, images }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
      <div className="relative w-full max-w-4xl p-4">
        <button
          onClick={onClose}
          className="absolute right-6 top-6 z-10 rounded-full bg-white p-2 hover:bg-gray-100"
        >
          <X className="h-6 w-6" />
        </button>
        <ImageGallery
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {listing.floorPlan && (
              <div className="bg-slate-50 p-4 rounded-lg">
                ...
                >
                  <img
                    src={Array.isArray(listing.floorPlan) ? listing.floorPlan[0] : listing.floorPlan}
                    alt="Floor Plan"
            ...
            <FloorPlanModal
              ...
              images={Array.isArray(listing.floorPlan) ? listing.floorPlan : [listing.floorPlan]}
            />
          ...
          <div className="lg:col-span-1">
            ...
            {(listing.contactemail || listing.contactnumber) && (
