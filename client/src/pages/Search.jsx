...
export default function Search() {
  ...
  const [sidebarData, setSidebardata] = useState({
    ...
    sort: "created_at",
    order: "desc",
    priceRange: "", // Add priceRange to state
  });
  ...
  useEffect(() => {
    ...
    const priceRangeFromUrl = urlParams.get("priceRange"); // Get priceRange from URL
    ...
    if (
      ...
      setSidebardata({
        ...
        priceRange: priceRangeFromUrl || "", // Set priceRange in state
      });
    }
  ...
  const handleChange = (e) => {
    ...
    if (e.target.id === "priceRange") {
      setSidebardata({ ...sidebarData, priceRange: e.target.value });
    }
  };
  ...
  const handleSubmit = (e) => {
    ...
    urlParams.set("priceRange", sidebarData.priceRange); // Add priceRange to URL params
    const searchQuery = urlParams.toString();
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              id="priceRange"
              onChange={handleChange}
              value={sidebarData.priceRange}
            >
              <option value="">Select Price Range</option>
              <option value="50-500">$0 - $500</option>
              <option value="500-5000">$500 - $5000</option>
              <option value="5000-50000">$5000 - $50000</option>
              <option value="50000-500000">$50000 - $500000</option>
